 ...
 */
var offmapcfg = {
    'home': '/static/offlineMap/',
    'imgext': '.jpg', // 瓦片图的后缀 ------ 根据需要修改，一般是 .png .jpg
    'tiles_dir': 'http://yjgb.poopp.cn/map/tiles', // 普通瓦片图的地址，为空默认在 offlineemap/tiles/ 目录
...
(function () {
    ...
    x.da.la < 8 ? (ka.for = 'htmlFor', ka.class = 'className') : (ka.htmlFor = 'for', ka.className = 'class');
    x.D.AG = ka;
    ...
    x.Rk.Po = function (a, b) {
        ...
        if (c.length) {
            ...
            return a.replace(/#\{(.+?)\}/g, function (a, b) {
                var g = c[b];
                d.call(g) == '[object Function]' && (g = g(b));
    ...
    x.D.Ua = function (a, b) {
        a = x.D.$(a);
        if (a === p) return a;
        for (var c = b.split(/\s+/), d = a.className, e = ' ' + d + ' ', f = 0, g = c.length; f < g; f++) e.indexOf(' ' + c[f] + ' ') < 0 && (d += (' ' + c[f]));
        a.className = d;
        return a;
    };
    x.Ua = x.D.Ua;
    ...
    x.da.qE = document.compatMode == 'CSS1Compat';
    x.D.ha = function (a) {
        a = x.D.$(a);
        if (a === p) return a;
        var b = x.D.ED(a),
        ...
        if (a.getBoundingClientRect) {
            ...
            e.left -= b.documentElement.clientLeft;
            e.top -= b.documentElement.clientTop;
            a = b.body;
            ...
            if (c.opera > 0 || c.kM > 0 && d(a, 'position') == 'absolute') e.top -= b.body.offsetTop;
            for (f = a.offsetParent; f && f != b.body;) {
                e.left -= f.scrollLeft;
                if (!c.opera || f.tagName != 'TR') e.top -= f.scrollTop;
                f = f.offsetParent;
            }
        }
        return e;
    ...
    x.SK = (function () {
        ...
        a.prototype = {
            ...
            move: function (a) {
                ...
                if (Math.abs((this.yk ? a.touches[0].clientX : a.clientX) - this.du) > 10 || Math.abs(c - this.eu) > 10) this.ph = o;
            },
            end: function (a) {
                oa(a);
...
if (x.da[d[e]]) {
    ...
    x.extend(La.prototype, {
        ...
        vB: function (a) {
            var b = a.style;
            b.overflow = 'hidden';
            Wa(a).position !== 'absolute' && (b.position = 'relative', b.zIndex = 0);
        ...
        Wf: function (a) {
            ...
            if (a instanceof H) {
                ...
                if (b.Ib === Pa) {
                    ...
                    var d = this.HH();
                    d.uF(function (c) {
                        d.tm() === 0 && d.Fa.result.type === 2 && (b.Wf(c.wk(0).point), Pa.sk(a) && b.oF(a));
                    });
                    d.search(a, {
                        log: 'center'
                    });
        ...
        Dd: function (a, b) {
            ...
            if ($a(a)) {
                if (c.Ib === Pa) {
                    ...
                    var e = c.HH();
                    e.uF(function (d) {
                        if (e.tm() === 0 && (e.Fa.result.type === 2 || e.Fa.result.type === 11)) {
                            var d = d.wk(0).point,
        ...
        Zs: function (a, b) {
            ...
            if (!a || !(a instanceof eb) && a.length === 0 || a instanceof eb && a.xj()) return c;
            var d = [];
        ...
        Vb: function () {
            var a = this.fa() >= this.K.RF && this.pa() === Ma && this.fa() <= 18,
                b = q;
            try {
	...
	*/
    ...
    z.sg = function (a, b) {
        ...
        case 'main_domain_cdn':
            ...
            break;
        default:
            d = z.url.domain[a], Object.prototype.toString.call(d) == '[object Array]' ? (c = [], x.kc.Gb(d, function (a, d) {
                c[d] = z.url.proto + a + '/' + b;
    ...
    function ub (a) {
        var b = ab();
        b >= a.Vz ? (Ya(a.k.va) && a.k.va(a.k.jc(1)), Ya(a.k.finish) && a.k.finish(), a.Zf.length > 0 && (b = a.Zf[0], b.Zf = [].concat(a.Zf.slice(1)), b.start())) : (a.uy = a.k.jc((b - a.Ku) / a.k.duration), Ya(a.k.va) && a.k.va(a.uy), a.DF || (a.Rr = setTimeout(function () {
            ub(a);
        }, 1E3 / a.k.Gc)));
    }
    ...
    function wb (a) {
        x.da.la > 0 ? a.unselectable = 'on' : a.style.MozUserSelect = 'none';
    }
    function xb (a) {
    ...
    function Ib (a) {
        ...
        do c = Hb.indexOf(a.charAt(i++)), d = Hb.indexOf(a.charAt(i++)), f = Hb.indexOf(a.charAt(i++)), g = Hb.indexOf(a.charAt(i++)), c = c << 2 | d >> 4, d = (d & 15) << 4 | f >> 2, e = (f & 3) << 6 | g, b += String.fromCharCode(c), f != 64 && (b += String.fromCharCode(d)), g != 64 && (b += String.fromCharCode(e));
        while (i < a.length);
        return b;
    }
    var O = x.lang.Xy;
        ...
        (function (a, b, c) {
            ...
            n && (n.yh && k() < n.yh) && (c.alog('cus.on', 'time', function (a) {
                ...
                if ('[object Object]' === a.toString()) {
                    for (var g in a)'page' == g ? b.page = a[g] : (e = parseInt(a[g]), e > 0 && /^z_/.test(g) && (d = o, b[g] = e));
    ...
    location.protocol === 'https:' && z.alog('cus.fire', 'count', 'z_httpscount');
    ...
    x.Iy = (function () {
        ...
        return {
            ...
            set: function (a, f) {
                if (d) {
                    for (var g = b + a + '_', i = c.length, k; i--;) k = c.key(i), k.indexOf(g) > -1 && c.removeItem(k);
                    try {
    ...
    x.extend(Tb.prototype, {
        ...
        qc: function (a) {
            if (this.q1 || !Xa(a) || isNaN(a) || a < Ub || a > 3) a = this.defaultAnchor;
            this.k = this.k || {
                zg: q
            };
    ...
    function lb (a) {
        ...
        this.qc(a.anchor);
        Object.prototype.toString.call(a.mapTypes) == '[object Array]' && (this.k.nh = a.mapTypes.slice(0));
        this.Ae();
    }
    ...
    x.object.extend(dc.prototype, {
        ...
        qw: function (a) {
            if (a && !(a.Mb != 'menuitem' || a.Tg == '' || a.Zi <= 0)) {
        ...
        bF: function (a) {
            if (this.Ce[a]) {
                for (var b = 0, c = this.ya.length; b < c; b++) this.ya[b] && (this.ya[b].Mb == 'divider' && this.ya[b].Nj == a) && (this.ya.splice(b, 1), c--), this.ya[b] && (this.ya[b].Mb == 'divider' && this.ya[b].Nj > a) && this.ya[b].Nj--;
                this.Ce.splice(a, 1);
            }
        },
        Id: u('B'),
...
if (b.lat <= -this.Bu[d]) {
    ...
    z.Ue(function (a) {
        ...
        x.da.la && x.da.la < 8 || document.compatMode === 'BackCompat' ? a.addEventListener('zoomend', function (a) {
            setTimeout(function () {
                b.draw(a);
            }, 20);
 ...
 if (b.Be[d] === a) {
    ...
    nc.prototype.draw = function (a) {
        if (z.bq) {
            ...
            b.Mb === 'canvas' && b.canvas && b.zQ(b.canvas.getContext('2d'));
        }
    ...
    function oc (a) {
        ...
        this.z = {
            ...
            ni: a.icons && a.icons.length > 0 ? a.icons : p
        };
        this.z.nc <= 0 && (this.z.nc = 5);
        if (this.z.rd < 0 || this.z.rd > 1) this.z.rd = 0.65;
        if (this.z.qg < 0 || this.z.qg > 1) this.z.qg = 0.65;
        this.z.strokeStyle != 'solid' && this.z.strokeStyle != 'dashed' && (this.z.strokeStyle = 'solid');
        this.V = p;
        this.Lu = new eb(0, 0);
        this.ef = [];
        this.oc = [];
    ...
    x.extend(oc.prototype, {
        ...
        Np: function (a) {
            a != 'solid' && a != 'dashed' || (this.z.strokeStyle = a);
        },
        BL: function () {
    ...
    x.extend(pc.prototype, {
        Hj: function () {
            ...
            a.borderColor != 'none' && c.push('border:' + a.Qx + 'px ' + a.yY + ' ' + a.vM + ';');
    ...
    function rc (a, b) {
        if (a) {
            ...
            this.Mb = typeof a === 'number' ? a : 'UserDefined';
    ...
    x.extend(tc.prototype, {
        setWidth: function (a) {
            !a && a != 0 || (isNaN(a) || a < 0) || (a != 0 && (a < 220 && (a = 220), a > 730 && (a = 730)), this.z.width = a);
        },
        setHeight: function (a) {
            !a && a != 0 || (isNaN(a) || a < 0) || (a != 0 && (a < 60 && (a = 60), a > 650 && (a = 650)), this.z.height = a);
        },
        SN: function (a) {
            !a && a != 0 || (isNaN(a) || a < 0) || (a != 0 && (a < 220 && (a = 220), a > 730 && (a = 730)), this.z.maxWidth = a);
        },
        Cc: function (a) {
            this.z.title = a;
        },
    ...
    function zc (a, b) {
        var c = this;
        yc() && (a === j && aa(Error('\u6ca1\u6709\u4f20\u5165points\u6570\u636e')), Object.prototype.toString.call(a) !== '[object Array]' && aa(Error('points\u6570\u636e\u4e0d\u662f\u6570\u7ec4')), b = b || {}, fb.apply(c, arguments), c.ea = {
            ia: a
        }, c.z = {
            shape: b.shape || wc,
            size: b.size || xc,
    ...
    x.extend(Cc.prototype, {
        ...
        dn: function (a, b) {
            this.po[a] && (this.po[a] = new H(b.lng, b.lat), this.ia[a] = new H(b.lng, b.lat), a == 0 && !this.ia[0].nb(this.ia[this.ia.length - 1]) && (this.ia[this.ia.length - 1] = new H(b.lng, b.lat)), this.Eh());
        },
        qe: function () {
            var a = this.po;
    ...
    x.extend(Gc.prototype, {
        ...
        yf: function () {
            ...
            this.qh == 0 && (this.Li && (clearTimeout(this.Li), this.Li = p), this.Li = setTimeout(function () {
                if (a.qh == 0) {
        ...
        wm: function (a, b, c) {
            ...
            l = 0;
            for (d = this.Qc.length; l < d; l++) A = this.Qc[l][0], i = this.Qc[l][1], t = A * e + g[0] - c / 2, v = (-1 - i) * e + g[1] - c / 2, y = k + '_' + b + '_' + A + '_' + i + '_' + f, m = this.Pm[y], n = p, m ? (n = m.style, n.left = t + 'px', n.top = v + 'px', m.Ze || this.kn.push([A, i, m])) : (this.Ne.length > 0 ? (m = this.Ne.shift(), m.getContext('2d').clearRect(-c / 2, -c / 2, w, w), n = m.style) : (m = document.createElement('canvas'), n = m.style, n.position = 'absolute', n.width = e + c + 'px', n.height = e + c + 'px', this.Mx() && (n.WebkitTransform = 'scale(1.001)'), m.setAttribute('width', w), m.setAttribute('height', w), a.appendChild(m)), m.id = y, n.left = t + 'px', n.top = v + 'px', y.indexOf('bg') > -1 && (t = '#F3F1EC', this.map.K.xo && (t = this.map.K.xo), n.background = t || ''), this.kn.push([A, i, m])), m.style.visibility = '';
            l = 0;
...
w.push([n, y]), d.JB.push({
        ...
        Qt: function (a) {
            ...
            if (!this.map.Vb() && (a ? this.map.K.s_ = a : a = this.map.K.s_, a)) {
                for (var c = p, c = z.Ny == '2' ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + '/'] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + '/', z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + '/', z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + '/'], d = 0, e; e = this.Jm[d]; d++) { 
if (e.f_ == o) {
                    b.k.$b = 18;
    ...
    Lc.prototype.Yn = function () {
        this.Hb.src = x.da.la > 0 && x.da.la <= 6 && this.pJ ? E.qa + 'blank.gif' : this.src !== '' && this.Hb.src == this.src ? this.src + '&t = ' + Date.now() : this.src;
    };
    ...
    function Vc (a, b, c) {
        ...
        this.ir.length >= 1 && (this.ir[0].ww = o);
        x.extend(this.k, c);
    }
    x.extend(Vc.prototype, {
        getName: u('cf'),
    ...
    function V (a, b) {
        ...
        this.k.ka.Xg = typeof b !== 'undefined' && typeof b.renderOptions !== 'undefined' && typeof b.renderOptions.autoViewport !== 'undefined' ? b.renderOptions.autoViewport : o;
    ...
    var dd = {
        ...
        bb: function (a, b, c, d, e) {
            ...
            z._rd['_cbk' + f] = function (b) {
                b.result && b.result.error && b.result.error === 202 ? alert('\u8be5AK\u56e0\u4e3a\u6076\u610f\u884c\u4e3a\u5df2\u7ecf\u88ab\u7ba1\u7406\u5458\u5c01\u7981\uff01') : (c = c || {}, a && a(b, c), delete z._rd['_cbk' + f]);
            };
            d = d || '';
    ...
    function ud (a, b, c) {
        x.lang.Ca.call(this);
        if (a) {
            this.Va = typeof a === 'object' ? a : x.Dc(a);
            this.page = 1;
            this.Jd = 100;
            this.SJ = 'pg';
            this.Vf = 4;
            ...
            c || (c = a);
            for (var d in c) typeof c[d] !== 'undefined' && (this[d] = c[d]);
            this.va();
        }
    }
    x.extend(ud.prototype, {
        ...
        QV: function () {
            ...
            if (this.page < this.Vf) d = this.page % this.Vf == 0 ? this.page - this.Vf - 1 : this.page - this.page % this.Vf + 1, b = d + this.Vf - 1;
            else {
            ...
            for (e = d; e <= b; e++) e > 0 && (e == this.page ? a.push('<span style="margin-right:3px">' + e + '</span>') : e >= 1 && e <= this.Jd && (d = '<span><a style="color:#7777cc;margin-right:3px" href="javascript:void(0)" onclick="{temp3}">[' + e + ']</a></span>', a.push(d.replace('{temp3}', 'BMap.I(\'' + this.ba + '\').toPage(' + e + ');'))));
        ...
        toPage: function (a) {
            a = a || 1;
            typeof this.$J === 'function' && (this.$J(a), this.page = a);
            this.update && this.va();
        }
    });
    ...
    function bb (a, b) {
        ...
        typeof b.renderOptions.selectFirstResult !== 'undefined' && !b.renderOptions.selectFirstResult ? this.JC() : this.fD();
        this.wa = [];
        this.wf = [];
        this.kb = -1;
        this.Pa = [];
    ...
    x.extend(bb.prototype, {
        ...
        Kp: function (a) {
            this.k.Ek = typeof a === 'number' && !isNaN(a) ? a < 1 ? bb.$p : a > bb.zn ? bb.$p : a : bb.$p;
        },
        pf: function () {
            return this.k.Ek;
        },
    ...
    x.extend(xd.prototype, {
        ...
        Kp: function (a) {
            ...
            this.k.Ek = typeof a !== 'number' ? xd.zn : a >= 1 && a <= xd.zn ? Math.round(a) : xd.zn;
        },
    ...
    function Oa (a, b) {
        function c () {
            e.k.visible ? (e.Ie === 'inter' && e.k.haveBreakId && e.k.indoorExitControl === o ? x.D.show(e.tA) : x.D.U(e.tA), this.k.closeControl && this.zf && this.C && this.C.Na() === this.B ? x.D.show(e.zf) : x.D.U(e.zf), this.k.forceCloseControl && x.D.show(e.zf)) : (x.D.U(e.zf), x.D.U(e.tA));
        }
        ...
        this.Pg = [];
        this.tr = [];
        this.ck == 'cvsRender' || Na() ? (this.Vj = 90, this.Xj = -90) : this.ck == 'cssRender' && (this.Vj = 45, this.Xj = -45);
        this.xr = q;
        var e = this;
        this.Yn = function () {
    ...
    x.extend(Oa.prototype, {
        ...
        CT: function (a) {
            ...
            b = a.style;
            c = Wa(a).position;
            c != 'absolute' && c != 'relative' && (b.position = 'relative', b.zIndex = 0);
            if (c === 'absolute' || c === 'relative') if (a = Wa(a).zIndex, !a || a === 'auto') b.zIndex = 0;
        },
        iX: u('Xn'),
        Zb: u('Ya'),
        KX: u('Vv'),
        ...
        Nc: function (a) {
            a != this.Jc && (a > Nd && (a = Nd), a < Od && (a = Od), a != this.Jc && (this.Jc = a), this.ck === 'cssRender' && this.Mc(this.Da));
        },
        tB: function () {
        ...
        Kk: function (a) {
            for (var b in a) {
                if (typeof a[b] === 'object') for (var c in a[b]) this.k[b][c] = a[b][c];
                else this.k[b] = a[b];
        ...
        Xq: function () {
            return Va() && !G() && this.k.panoramaRenderer !== 'javascript' ? 'flashRender' : !G() && Nb() ? 'cvsRender' : 'cssRender';
        },
        Ja: function (a) {
            this.He[a.hd] = a;
        },
    ...
    function Na (a) {
        if (typeof Wd === 'boolean') return Wd;
        if (a === q || !window.WebGLRenderingContext || x.platform.Fm && navigator.userAgent.indexOf('Android 5') == -1) return Wd = q;
        var a = document.createElement('canvas'),
            b = p;
        try {
    ...
    function Xd () {
        if (typeof Yd === 'boolean') return Yd;
        Yd = o;
        if (x.platform.mE) return o;
        var a = navigator.userAgent;
        return a.indexOf('Chrome') > -1 || a.indexOf('SAMSUNG-GT-I9508') > -1 ? o : Yd = q;
    }
    var Yd;
...
switch (b['_' + c] = a[c], c) {
    ...
    bc.prototype.getTilesUrl = function (a, b) {
        ...
        x.da.la && x.da.la <= 6 && (c += '&color_dep=32');
        return c;
    };
    ...
    x.extend($d, {
        iW: function (a, b, c) {
            ...
            a == 'position_changed' && (b.data = $d.Ud.zj(new Q(b.data.mercatorX, b.data.mercatorY)));
    ...
    function Ne (a, b) {
        var c = this,
            d;
        c.tn = typeof a === 'object' ? a : ce.getElementById(a);
        ...
        c.ca(Ee, window);
        c.ca(Fe);
        !Be && c.options.TO != 'none' && (c.ca('DOMMouseScroll'), c.ca('mousewheel'));
    ...
    Ne.prototype = {
        ...
        CQ: function (a) {
            ...
            if (b != 'select' && b != 'input' && b != 'textarea') return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.jZ = o, a.stopPropagation(), a.preventDefault(), this.ax = this.LB = p, q;
        },
        Ov: function (a) {
            ...
            if (this.enabled) {
                ...
                this.options.zoom && (Be && a.touches.length > 1) && (d = de.abs(a.touches[0].pageX - a.touches[1].pageX), c = de.abs(a.touches[0].pageY - a.touches[1].pageY), this.G_ = de.sqrt(d * d + c * c), this.dy = de.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.TF) / 2 - this.x, this.ey = de.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.UF) / 2 - this.y, this.options.vp && this.options.vp.call(this, a));
        ...
        aT: function (a) {
            ...
            if (this.options.zoom && Be && a.touches.length > 1) e = de.abs(a.touches[0].pageX - a.touches[1].pageX), f = de.abs(a.touches[0].pageY - a.touches[1].pageY), this.F_ = de.sqrt(e * e + f * f), this.Wk = o, b = 1 / this.G_ * this.F_ * this.scale, b < this.options.Vk ? b = 0.5 * this.options.Vk * Math.pow(2, b / this.options.Vk) : b > this.options.Wp && (b = 2 * this.options.Wp * Math.pow(0.5, this.options.Wp / b)), this.op = b / this.scale, e = this.dy - this.dy * this.op + this.x, f = this.ey - this.ey * this.op + this.y, this.Ob.style[ne] = 'translate(' + e + 'px,' + f + 'px) scale(' + b + ')' + Me, this.options.lN && this.options.lN.call(this, a);
            else {
                this.th = b.pageX;
                this.uh = b.pageY;
                if (e > 0 || e < this.fe) e = this.options.zo ? this.x + c / 2 : e >= 0 || this.fe >= 0 ? 0 : this.fe;
                if (f > this.rf || f < this.nd) f = this.options.zo ? this.y + d / 2 : f >= this.rf || this.nd >= 0 ? this.rf : this.nd;
                this.LC += c;
                this.MC += d;
                this.fw = de.abs(this.LC);
                this.gw = de.abs(this.MC);
                this.fw < 6 && this.gw < 6 || (this.options.BE && (this.fw > this.gw + 5 ? (f = this.y, d = 0) : this.gw > this.fw + 5 && (e = this.x, c = 0)), this.ph = o, this.wr(e, f), this.FC = c > 0 ? -1 : c < 0 ? 1 : 0, this.GC = d > 0 ? -1 : d < 0 ? 1 : 0, g - this.startTime > 300 && (this.startTime = g, this.du = this.x, this.eu = this.y), this.options.iN && this.options.iN.call(this, a));
            }
        },
        $u: function (a) {
            if (!(Be && a.touches.length !== 0)) {
                var b = this,
                ...
                if (b.Wk) d = b.scale * b.op, d = Math.max(b.options.Vk, d), d = Math.min(b.options.Wp, d), b.op = d / b.scale, b.scale = d, b.x = b.dy - b.dy * b.op + b.x, b.y = b.ey - b.ey * b.op + b.y, b.Ob.style[ue] = '200ms', b.Ob.style[ne] = 'translate(' + b.x + 'px,' + b.y + 'px) scale(' + b.scale + ')' + Me, b.Wk = q, b.refresh(), b.options.up && b.options.up.call(b, a);
                    ...
                    if (b.ph) {
                        if (i < 300 && b.options.Vx) {
                            ...
                            g = e ? b.lI(e - b.eu, i, -b.y, b.nd < 0 ? b.Fp - b.vn + b.y - b.rf : 0, b.options.zo ? b.vn : 0) : g;
                            d = b.x + f.Ba;
                            e = b.y + g.Ba;
                            if (b.x > 0 && d > 0 || b.x < b.fe && d < b.fe) {
                                f = {
                                    Ba: 0,
                                    time: 0
                                }; 
 ...
 clearTimeout(b.EK), b.EK = p, b.options.vp && b.options.vp.call(b, a), b.zoom(b.th, b.uh, b.scale == 1 ? b.options.kW : 1), b.options.up && setTimeout(function () {
                                b.options.up.call(b, a);
                            }, 200); } else if (this.options.zx) {
                                for (d = c.target; d.nodeType != 1;) d = d.parentNode;
                                e = d.tagName.toLowerCase();
                                e != 'select' && e != 'input' && e != 'textarea' ? (e = ce.createEvent('MouseEvents'), e.initMouseEvent('click', o, o, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, 0, p), e.yR = o, d.dispatchEvent(e)) : d.focus();
                            }
                        }
                        b.fo(400);
                    }
        ...
        fo: function (a) {
            var b = this.x >= 0 ? 0 : this.x < this.fe ? this.fe : this.x,
                c = this.y >= this.rf || this.nd > 0 ? this.rf : this.y < this.nd ? this.nd : this.y;
            if (b == this.x && c == this.y) {
                if (this.ph && (this.ph = q, this.options.ay && this.options.ay.call(this)), this.mi && this.options.Dx && (fe == 'webkit' && (this.ML.style[xe] = '300ms'), this.ML.style.opacity = '0'), this.Bi && this.options.Dx)fe == 'webkit' && (this.LO.style[xe] = '300ms'), this.LO.style.opacity = '0';
        ...
        EU: function (a) {
            ...
            } else c = b.x + c, d = b.y + d, c > 0 ? c = 0 : c < b.fe && (c = b.fe), d > b.rf ? d = b.rf : d < b.nd && (d = b.nd), b.nd < 0 && b.scrollTo(c, d, 0);
        },
        AU: function (a) {
        ...
        refresh: function () {
            ...
            this.gp = this.options.gp && this.fe < 0;
            ...
            this.TF = -a.left;
            this.UF = -a.top;
            if (typeof this.options.au === 'string') {
                this.Se = [];
                this.uf = [];
    ...
    x.extend(Oe.prototype, {
        ...
        CH: function (a) {
            for (var b = this.$j, c = b.length - 1; c >= 0; c--) if (b[c].panoId == a) return c;
            return -1;
        },
        ny: function (a, b) {
            if (b || !this.$j[this.Xc] || !(this.$j[this.Xc].panoId == a && this.$j[this.Xc].recoType !== 3)) {
                var c = this,
                    d = this.CH(a);
                !b && d !== -1 && this.$j[d] && this.$j[d].recoType !== 3 ? this.Jp(d) : this.xX(function (a) {
        ...
        Dl: function (a) {
            this.$j = a;
            this.k.showCatalog && (this.Ni.length > 0 ? (Va() ? this.OV() : this.RV(), this.Oc.offsetLeft = 60) : (this.Hs && (this.B.removeChild(this.Hs), this.Hs = p, this.Oc.fg.style.left = '0px'), this.Ki && (this.B.removeChild(this.Ki), this.Ki = p), this.Oc.offsetLeft = 0));
            var b = this.fX(a);
            Va() && (this.Ni && this.Ni.length > 0 && this.k.showExit && this.Wz) && (this.Oc.offsetLeft += this.eg.width + 8, this.Hs ? this.Hs.innerHTML = this.Wz : this.PV());
            this.Wh.innerHTML = b;
            ...
            a = this.CH(this.P.Zb(), this.g1); a !== -1 && this.Jp(a);
        },
        lX: function (a) {
        ...
        qc: function (a) {
            if (!Xa(a) || isNaN(a) || a < Ub || a > 3) a = this.defaultAnchor;
            var b = this.B,
        ...
        kK: function (a, b) {
            ...
            c = g - c;
            f -= e;
            c < f && (!b || b && g - f > 8) && this.Oc.scrollTo(c + e + d);
        },
        fY: function () {
